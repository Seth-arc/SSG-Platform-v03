import{c as V,s as x,a as c,n as I,f as u,O,g as J,o as K,h as H,q as T,r as D,t as j,u as N,v as q,d as g,j as f}from"./main-BYET35L_.js";import{v as Q}from"./validation-BnFSv1Ez.js";import{c as v,f as h}from"./formatting-QmcNEoUH.js";import{s as W,c as X,a as R}from"./Modal-O3kyaPUL.js";import"./supabase-BQbgwcOn.js";function Y({session:i=null,gameState:e=null,actions:t=[],requests:s=[],timeline:n=[],participants:a=[],exportedAt:r=new Date().toISOString(),version:o="2.0.0"}={}){return{exportedAt:r,version:o,session:i,gameState:e,actions:t,requests:s,timeline:n,participants:a}}function Z(i,e="esg-export.json"){const t=JSON.stringify(i,null,2),s=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(s),a=document.createElement("a");a.href=n,a.download=e,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(n)}function L(i,e){if(!i||i.length===0)return e.join(",");const t=e.join(","),s=i.map(n=>e.map(a=>{const r=n[a];if(r==null)return"";if(Array.isArray(r))return`"${r.join("; ").replace(/"/g,'""')}"`;if(typeof r=="object")return`"${JSON.stringify(r).replace(/"/g,'""')}"`;const o=String(r);return o.includes(",")||o.includes(`
`)||o.includes('"')?`"${o.replace(/"/g,'""')}"`:o}).join(","));return[t,...s].join(`
`)}function ee(i=[]){return L(i,["id","team","move","phase","mechanism","sector","exposure_type","targets","goal","expected_outcomes","ally_contingencies","priority","status","outcome","adjudication_notes","created_at","submitted_at","adjudicated_at","updated_at"])}function te(i=[]){return L(i,["id","team","move","phase","priority","categories","query","status","response","responded_by","responded_at","created_at"])}function se(i=[]){return L(i,["id","type","team","move","phase","category","content","faction_tag","debate_marker","created_at"])}function ne(i=[]){return L(i,["id","display_name","role","is_active","joined_at","heartbeat_at","disconnected_at","client_id"])}function b(i,e){const t=new Blob([i],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(t),n=document.createElement("a");n.href=s,n.download=e,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(s)}const d=V("GameMaster");function w(i){return i?new Date(i).getTime():0}function k(i="session"){return String(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"session"}function ie(i){return{session:i,gameState:null,participants:[],actions:[],requests:[],timeline:[]}}function ae(i={}){return typeof(i==null?void 0:i.is_active)=="boolean"?i.is_active:!0}function z(i=[]){return i.filter(e=>ae(e))}function A(i=[]){const e=i.length,t=z(i).length;return{total:e,connected:t}}function re(i=[]){const{total:e,connected:t}=A(i);return e===0?"No participants have joined this session.":t===e?`${t} connected participant${t===1?"":"s"}`:`${t} connected / ${e} total participants`}function S(i=[],e=[]){return Array.isArray(i)&&i.length>0?i:Array.isArray(e)&&e.length>0?e:Array.isArray(i)?i:Array.isArray(e)?e:[]}function oe(i=x){var s,n,a,r;const e=((s=i.getRole)==null?void 0:s.call(i))||((a=(n=i.getSessionData)==null?void 0:n.call(i))==null?void 0:a.role)||null,t=e==="white"&&((r=i.hasOperatorAccess)==null?void 0:r.call(i,O.GAME_MASTER,{role:"white"}));return{allowed:e==="white",role:e,cachedOperatorAccess:t}}function C(i=[]){return{activeSessions:i.length,totalParticipants:i.reduce((e,t)=>e+A(t.participants||[]).connected,0),totalActions:i.reduce((e,t)=>{var s;return e+(((s=t.actions)==null?void 0:s.length)||0)},0),pendingRequests:i.reduce((e,t)=>{var s;return e+(((s=t.requests)==null?void 0:s.filter(n=>n.status==="pending").length)||0)},0)}}function U(i=[],e=8){return i.flatMap(t=>(t.timeline||[]).map(s=>{var n,a;return{...s,sessionId:((n=t.session)==null?void 0:n.id)||null,sessionName:((a=t.session)==null?void 0:a.name)||"Unknown Session"}})).sort((t,s)=>w(s.created_at)-w(t.created_at)).slice(0,e)}function F(i=[],e=10){return i.flatMap(t=>z(t.participants||[]).map(s=>{var n,a;return{...s,sessionId:((n=t.session)==null?void 0:n.id)||null,sessionName:((a=t.session)==null?void 0:a.name)||"Unknown Session"}})).sort((t,s)=>w(s.heartbeat_at||s.joined_at)-w(t.heartbeat_at||t.joined_at)).slice(0,e)}function $(){return[{id:"exportJsonBtn",action:"json",successLabel:"JSON"},{id:"exportActionsCsvBtn",action:"csv-actions",successLabel:"Actions CSV"},{id:"exportRequestsCsvBtn",action:"csv-requests",successLabel:"RFIs CSV"},{id:"exportTimelineCsvBtn",action:"csv-timeline",successLabel:"Timeline CSV"},{id:"exportParticipantsCsvBtn",action:"csv-participants",successLabel:"Participants CSV"}]}function ce(i=null){return i!=null&&i.session?{disabled:!1,message:`JSON and CSV exports are ready for ${i.session.name}.`}:{disabled:!0,message:"Select a session before exporting JSON or CSV data."}}class de{constructor(){this.sessions=[],this.currentSessionId=null,this.sessionBundles=new Map,this.storeUnsubscribers=[]}async init(){if(d.info("Initializing Game Master interface"),!oe(x).allowed){d.warn("Blocked direct Game Master access without operator auth"),c("Game Master access requires operator authorization from the landing page.",{type:"error"}),I("index.html#operatorAccessSection",{replace:!0});return}try{const t=await u.requireOperatorGrant(O.GAME_MASTER,{role:"white"});x.setOperatorAuth(t)}catch(t){d.warn("Blocked Game Master access after failed server verification",t),x.clearOperatorAuth(),c("Game Master access requires a valid server-side operator grant.",{type:"error"}),I("index.html#operatorAccessSection",{replace:!0});return}if(!J().ready){d.error("Game Master page blocked: backend configuration is missing");return}this.bindEventListeners(),this.subscribeToLiveStores(),await this.loadSessions(),d.info("Game Master interface initialized")}bindEventListeners(){const e=document.getElementById("createSessionBtn");e&&e.addEventListener("click",()=>this.showCreateSessionModal());const t=document.getElementById("refreshDashboardBtn");t&&t.addEventListener("click",()=>this.loadSessions());const s=document.getElementById("participantsSessionSelect");s&&s.addEventListener("change",a=>{this.handleSessionSelectionChange(a.target.value)});const n=document.getElementById("exportSessionSelect");n&&n.addEventListener("change",a=>{this.handleSessionSelectionChange(a.target.value)}),$().forEach(({id:a,action:r})=>{const o=document.getElementById(a);o&&o.addEventListener("click",()=>{this.exportData(r)})})}async loadSessions(){const e=document.getElementById("sessionsList"),t=e?K(e,{message:"Loading sessions...",replace:!1}):null;try{if(this.sessions=await u.getActiveSessions()||[],t&&t.hide(),this.currentSessionId&&!this.sessions.some(s=>s.id===this.currentSessionId)){this.currentSessionId=null;const s=document.getElementById("sessionDetailSection"),n=document.getElementById("sessionsSection");s&&(s.style.display="none"),n&&(n.style.display="block")}this.renderSessionsList(),this.renderSessionSelectors(),await this.loadDashboardData(),await this.refreshSelectedSessionViews(),d.info(`Loaded ${this.sessions.length} sessions`)}catch(s){d.error("Failed to load sessions:",s),c("Failed to load sessions",{type:"error"}),t&&t.hide()}}async loadDashboardData(){if(this.sessions.length===0){this.sessionBundles=new Map,this.renderDashboardStats(C([])),this.renderRecentActivity([]),this.renderActiveParticipants([]);return}const e=await Promise.all(this.sessions.map(async t=>{try{return await u.fetchSessionBundle(t.id)}catch(s){return d.error("Failed to load session bundle for dashboard:",t.id,s),ie(t)}}));this.sessionBundles=new Map(e.map(t=>[t.session.id,t])),this.renderDashboardStats(C(e)),this.renderRecentActivity(U(e)),this.renderActiveParticipants(F(e))}async handleSessionSelectionChange(e){this.currentSessionId=e||null,await this.refreshSelectedSessionViews(),this.renderSessionsList()}async ensureSessionBundle(e){if(!e)return null;const t=this.sessionBundles.get(e);if(t)return t;const s=await u.fetchSessionBundle(e);return this.sessionBundles.set(e,s),s}async refreshSelectedSessionViews(){if(this.renderSessionSelectors(),!this.currentSessionId){await H.reset(),this.updateHeaderSessionState(null,null),this.renderParticipantsPanel(null),this.updateExportAvailability(null);return}try{const e=await this.ensureSessionBundle(this.currentSessionId);this.applySelectedLiveBundle(e),await H.initialize(this.currentSessionId),this.applySelectedLiveBundle(e)}catch(e){d.error("Failed to refresh selected session views:",e),c("Failed to refresh selected session views",{type:"error"})}}subscribeToLiveStores(){const e=()=>{this.applySelectedLiveBundle()};this.storeUnsubscribers.push(T.subscribe(e)),this.storeUnsubscribers.push(D.subscribe(e)),this.storeUnsubscribers.push(j.subscribe(e)),this.storeUnsubscribers.push(N.subscribe(e)),this.storeUnsubscribers.push(q.subscribe(e))}buildSelectedLiveBundle(e=null){if(!this.currentSessionId)return null;const t=this.sessionBundles.get(this.currentSessionId)||null,s=e||t||null,n=(e==null?void 0:e.session)||(t==null?void 0:t.session)||this.sessions.find(a=>a.id===this.currentSessionId)||null;return n?{session:n,gameState:T.getState()||(s==null?void 0:s.gameState)||null,participants:S(q.getAll(),s==null?void 0:s.participants),actions:S(D.getAll(),s==null?void 0:s.actions),requests:S(j.getAll(),s==null?void 0:s.requests),timeline:S(N.getAll(),s==null?void 0:s.timeline)}:null}applySelectedLiveBundle(e=null){if(!this.currentSessionId)return;const t=this.buildSelectedLiveBundle(e);if(!t)return;this.sessionBundles.set(this.currentSessionId,t);const s=[...this.sessionBundles.values()];this.renderDashboardStats(C(s)),this.renderRecentActivity(U(s)),this.renderActiveParticipants(F(s)),this.updateHeaderSessionState(t.session,t.gameState),this.renderParticipantsPanel(t),this.updateExportAvailability(t);const n=document.getElementById("sessionDetailSection");(n==null?void 0:n.style.display)!=="none"&&this.renderSessionDetails(t.session,t.participants,t.gameState,t.actions,t.requests)}updateHeaderSessionState(e,t){const s=document.getElementById("sessionName"),n=document.getElementById("headerMove"),a=document.getElementById("headerPhase");s&&(s.textContent=e?e.name:"No Session Selected"),n&&(n.textContent=(t==null?void 0:t.move)??"-"),a&&(a.textContent=(t==null?void 0:t.phase)??"-")}renderSessionSelectors(){["participantsSessionSelect","exportSessionSelect"].forEach(e=>{const t=document.getElementById(e);if(!t)return;const s=this.currentSessionId||"";t.innerHTML=`
        ...
        `;const t={current:null};t.current=W({title:"Create New Session",content:e,size:"md",buttons:[{label:"Cancel",variant:"secondary",onClick:()=>{}},{label:"Create Session",variant:"primary",onClick:()=>(this.handleCreateSession(t.current),!1)}]})}async handleCreateSession(e){var o,m;const t=(e==null?void 0:e.element)||document,s=t.querySelector("#sessionName")||document.getElementById("sessionName"),n=t.querySelector("#sessionCode")||document.getElementById("sessionCode"),a=t.querySelector("#sessionDescription")||document.getElementById("sessionDescription");if(!((o=s==null?void 0:s.value)!=null&&o.trim())){c("Session name is required",{type:"error"}),s==null||s.focus();return}const r=Q((n==null?void 0:n.value)||"");if(r){c(r,{type:"error"}),n==null||n.focus();return}g({message:"Creating session..."});try{const p={name:s.value.trim(),session_code:n.value.trim().toUpperCase(),description:((m=a==null?void 0:a.value)==null?void 0:m.trim())||null,status:"active",move:1,phase:1},l=await u.createSession(p);c("Session created successfully",{type:"success"}),e&&typeof e.close=="function"?e.close():X(),this.currentSessionId=l.id,await this.loadSessions()}catch(p){d.error("Failed to create session:",p),c(p.message||"Failed to create session",{type:"error"})}finally{f()}}async viewSession(e){this.currentSessionId=e;const t=document.getElementById("sessionsSection"),s=document.getElementById("sessionDetailSection");t&&(t.style.display="none"),s&&(s.style.display="block"),this.renderSessionsList(),await this.refreshSelectedSessionViews()}renderSessionDetails(e,t,s,n=[],a=[]){var B;const r=document.getElementById("sessionDetailContent");if(!r)return;const o=((B=e.metadata)==null?void 0:B.session_code)||"N/A",m=(s==null?void 0:s.move)??1,p=(s==null?void 0:s.phase)??1,l=a.filter(y=>y.status==="pending").length,_=A(t);r.innerHTML=`
        ...
        `;const M=r.querySelector("#backToListBtn");M&&M.addEventListener("click",()=>{const y=document.getElementById("sessionsSection"),P=document.getElementById("sessionDetailSection");y&&(y.style.display="block"),P&&(P.style.display="none")}),this.bindParticipantRemovalControls(r,e,t)}renderParticipantsTable(e,{includeActions:t=!1,sessionName:s=""}={}){return e.length?`
            <table class="table" style="width: 100%;">
                ...
                <tbody>
                    ${e.map(n=>{const a=v({text:n.is_active?"Active":"Inactive",variant:n.is_active?"success":"default",size:"sm"});return`
                            <tr>
                                <td>${this.escapeHtml(n.display_name||"Unknown")}</td>
                                <td>${this.escapeHtml(n.role||"Unknown")}</td>
                                <td>${a.outerHTML}</td>
                                <td>${n.heartbeat_at?h(n.heartbeat_at):"Never"}</td>
                                ${t?`
                                    <td>
                                        <button
                                            type="button"
                                            class="btn btn-danger btn-sm"
                                            data-remove-session-participant-id="${this.escapeHtml(n.id||"")}"
                                            aria-label="Remove ${this.escapeHtml(n.display_name||"participant")} from ${this.escapeHtml(s||"this session")}"
                                        >
                                            Remove
                                        </button>
                                    </td>
        ...
        `,this.bindParticipantRemovalControls(s,e.session,e.participants)}}updateExportAvailability(e){const t=ce(e),s=document.getElementById("exportSelectionState");s&&(s.textContent=t.message),$().forEach(({id:n})=>{const a=document.getElementById(n);a&&(a.disabled=t.disabled)})}async confirmDeleteSession(e){const t=this.sessions.find(n=>n.id===e);if(!t)return;await R({title:"Delete Session",message:`Are you sure you want to delete "${t.name}"? This action cannot be undone and all associated data will be permanently deleted.`})&&await this.deleteSession(e)}bindParticipantRemovalControls(e,t,s=[]){if(!e||!(t!=null&&t.id))return;const n=new Map((Array.isArray(s)?s:[]).filter(a=>a==null?void 0:a.id).map(a=>[String(a.id),a]));e.querySelectorAll("[data-remove-session-participant-id]").forEach(a=>{a.addEventListener("click",()=>{const r=a.dataset.removeSessionParticipantId,o=n.get(String(r||""));if(!o){c("Participant seat data is no longer available. Refresh and try again.",{type:"error"});return}this.removeParticipantFromSession(t,o)})})}async removeParticipantFromSession(e,t){if(!(e!=null&&e.id)||!(t!=null&&t.id)){c("Participant selection is invalid.",{type:"error"});return}const s=t.display_name||"This participant",n=String(t.role||"unknown role").replace(/_/g," ");if(await R({title:"Remove Participant",message:`Remove ${s} (${n}) from ${e.name}? This clears the session seat immediately and requires a fresh join before the participant can return.`,confirmLabel:"Remove Participant",variant:"danger"})){g({message:`Removing ${s}...`});try{await u.removeSessionParticipant(e.id,t.id),this.sessionBundles.delete(e.id),await this.loadSessions(),c(`${s} was removed from ${e.name}.`,{type:"success"})}catch(r){d.error("Failed to remove participant:",r),c(r.message||"Failed to remove participant",{type:"error"})}finally{f()}}}async deleteSession(e){g({message:"Deleting session..."});try{await u.deleteSession(e),this.sessionBundles.delete(e),this.currentSessionId===e&&(this.currentSessionId=null),c("Session deleted successfully",{type:"success"}),await this.loadSessions()}catch(t){d.error("Failed to delete session:",t),c("Failed to delete session",{type:"error"})}finally{f()}}async exportData(e){var s,n,a,r;if(!this.currentSessionId){c("Select a session before exporting.",{type:"warning"});return}const t=$().find(o=>o.action===e);if(!t){c("Unsupported export action.",{type:"error"});return}g({message:"Preparing export..."});try{const o=this.buildSelectedLiveBundle()||await u.fetchSessionBundle(this.currentSessionId);this.sessionBundles.set(this.currentSessionId,o);const m=k(((s=o.session)==null?void 0:s.name)||this.currentSessionId),p=k(((a=(n=o.session)==null?void 0:n.metadata)==null?void 0:a.session_code)||((r=o.session)==null?void 0:r.id)||"session"),l=`esg-${m}-${p}`;switch(e){case"json":Z(Y(o),`${l}.json`);break;case"csv-actions":b(ee(o.actions),`${l}-actions.csv`);break;case"csv-requests":b(te(o.requests),`${l}-rfis.csv`);break;case"csv-timeline":b(se(o.timeline),`${l}-timeline.csv`);break;case"csv-participants":b(ne(o.participants),`${l}-participants.csv`);break;default:throw new Error(`Unhandled export action: ${e}`)}c(`${t.successLabel} export is ready.`,{type:"success"})}catch(o){d.error("Export failed:",o),c("Export failed",{type:"error"})}finally{f()}}escapeHtml(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}destroy(){this.storeUnsubscribers.forEach(e=>e==null?void 0:e()),this.storeUnsubscribers=[]}}const E=new de,G=typeof document<"u"&&!globalThis.__ESG_DISABLE_AUTO_INIT__;G&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{E.init()}):E.init());typeof window<"u"&&G&&window.addEventListener("beforeunload",()=>E.destroy());
//# sourceMappingURL=master-DWcr_EN3.js.map
